...
Sur le plan de sa mise en \o{e}uvre, les calculs CROCO peuvent s’exécuter en mode parallèle, ce qui permet une grande souplesse d'adaptation entre temps nécessaire de calcul d'un côté et résolution et temps modélisé de l'autre.
